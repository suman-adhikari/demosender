...
function ConfirmationDelete(obj, title, confirmMsg, okLabel, cancelLabel) {
    if (okLabel == null)
        okLabel = "Yes";
...
function showSuccessMessage(messageDivId, message) {
    ...
    var $successDiv = $("<div class=\"alert alert-success alert-dismissible\"></div>");
    $message = $("<div style='display:inline-block;'>").text(message);

    var $successGlyphicon = $("<div class='successMessage' style='display:inline-block;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>");
    $close = $("<button type='button' class='close' data-dismiss='alert' aria-label=''><span aria-hidden='true' style='color:green;'> x </span></button>");

    $successDiv.append($close);
...
function showFailureMessage(messageDivId, message) {
    ...
    var $errorDiv = $("<div class=\"alert alert-error alert-dismissible\"></div>");

    var $errorGlyphicon = $("<div class='errorMessage' style='display:inline-block;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>");
    $close = $("<button type='button' class='close' data-dismiss='alert' aria-label=''><span aria-hidden='true' style='color:red;'> x </span></button>");
...
function changeLanguage(language) {
    ...
    //document.cookie = "VasupDemoSender=" + language + ";" + expires + ";path=/";
    document.cookie = "VasupDemoSender=" + language + ";path=/";
