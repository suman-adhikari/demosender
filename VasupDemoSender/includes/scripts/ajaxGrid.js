                                            ...
                                            for (i = 0; i < options.postContent.length; i++) {
                                                ...
                                                if (postControl == null) {
                                                    if (options.postContent[i].removeWhen == null)
                                                        ...
                                                        if (!(options.postContent[i].removeWhen instanceof Array)) {

                                                            if (item[options.postContent[i].removeWhen.property] != options.postContent[i].removeWhen.value)
                                                                postControl = control;
                                                        } else {
                                                            var flag = false;
                                                            for (var l = 0; l < options.postContent[i].removeWhen.length; l++) {
                                                                if (item[options.postContent[i].removeWhen[l].property] != options.postContent[i].removeWhen[l].value) {
                                                                    postControl = control;
                                                                    flag = true;
                                                                    if (flag) {
                                                                        break;
